...
use Rampmaster\PHPTypistMe\Exception\TypesetterConfigException;
use Rampmaster\PHPTypistMe\Observers\DefaultMarkdownConfiguration;
...
class ConfigTest extends TestCase
{
    ...
    public function testMissingContentDirectoryThrowsException(): void
    {
        ...
        chdir(__DIR__ . '/../../assets/data/theme');
    ...
    public function testAllSpecifiedValues(): void
    {
        ...
        self::assertEquals(__DIR__ . '/../../assets/data/another-theme', $config->theme);
        self::assertEquals(__DIR__ . '/../../assets/data/content', $config->content);
